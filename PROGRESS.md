...
- [x] Crash recovery — handled by Inngest durable steps (automatic resume from last checkpoint); compaction wrapped in `step.run`, replay test via `@inngest/test`, contract documented in `design/crash-recovery.md`
