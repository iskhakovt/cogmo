...
| `core_memory_blocks` | [memory.md](memory.md) → Core Memory vs Hindsight | Structured persistent notes (user profile, projects). Upsert by (user_id, key). Always in system prompt. |
