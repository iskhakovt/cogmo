...
| Provider data model | DB table + profile FK | Survives model renames, supports multiple provider instances, matches LiteLLM/n8n/Dify pattern. Profile's `model` field stays a plain string. See [providers.md](providers.md). |
