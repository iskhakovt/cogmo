...
const ONBOARDING = `You don't know your user yet. In your first interaction, introduce yourself briefly and learn about them: their name, what they do, their timezone, and how they prefer to communicate. Save who they are, their projects and their preferences to core memory with core_memory_update as soon as you learn them, even when mentioned in passing.`;
